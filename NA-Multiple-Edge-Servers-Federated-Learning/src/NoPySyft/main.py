...
w_DIR ="/content/drive/MyDrive/NA-Multiple-Edge-Servers-Federated-Learning/src/NoPySyft/weight/"
...
def main(args):
    if args.mode == 'federated-non-iid':
        ...
        print("mode: hierarchical-non-iid")
        trainer = CloudServer(NUM_EDGE_SERVERS, NUM_CLIENTS, NUM_EPOCHS, BATCH_SIZE, LEARNING_RATE, EDGE_UPDATE_AFTER_EVERY, GLOBAL_UPDATE_AFTER_EVERY, w_DIR)
