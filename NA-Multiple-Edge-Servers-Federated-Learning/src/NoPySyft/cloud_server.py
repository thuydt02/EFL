...
acc_DIR = "/content/drive/MyDrive/NA-Multiple-Edge-Servers-Federated-Learning/src/NoPySyft/acc/"
z_DIR = "/content/drive/MyDrive/NA-Multiple-Edge-Servers-Federated-Learning/src/NoPySyft/z_ass/"

#z_FILENAME = "graph_weight_euclidean_diff.txt.part.10"
z_FILENAME = "z_rnd.csv"
...
#---------------------------------------------------
    ...
    def create_graph(self):
        ...
        z_matrix_fname = z_DIR + "d_weight_euclidean_diff.csv"
        fname = z_DIR + "graph_weight_euclidean_diff.txt"
    ...
    def pre_train_for_z_graph(self):
...
#---------------------------------------------------
    ...
    def train(self):
        ...
        #self.load_assignment(z_DIR + z_FILENAME)
        # Train
        ...
        with open(acc_DIR+acc_FILENAME, 'w') as the_file:
        ...
        for epoch in range(self.num_epochs):
            ...
            if (epoch+1) % self.global_update == 0:
                ...
                with open(acc_DIR+acc_FILENAME, 'a') as the_file:
    ...
    def save_model(self):
        ...
        if not os.path.exists(self.model_weight_dir):
            os.makedirs(self.model_weight_dir)
        torch.save(self.model.state_dict(), self.model_weight_dir + w_FILENAME)
        print("Model saved!")
