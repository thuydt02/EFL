...
#-------------------------------------------------------------------------------------
    ...
    def get_dcost_1_cluster(clt, d):
    # return the d_cost of a cluster
    # clt is a cluster eg: clt = [1, 2, 4] meaning this cluster has 3 clients 1, 2 and 4
    
        D = 0
        for i in range(len(clt)):
            for j in range(i + 1, len(clt), 1):
                D += d[clt[i]][clt[j]] **  2
        return D / len(clt)
#-------------------------------------------------------------------------------------

#Thuy: ending {new code area}
#-------------------------------------------------------------------------------------
	...
	def train(self):
		...
		print("running shortest_distance_clients_servers_assign()...")
		print("dien")
		print("dien")
		print("dien")
		print("dien")
